...
description: Routing webhooks from self-hosted services to ntfy servers with subdomain-based matching, delivery failover, and request filtering on Cloudflare Workers.
...
:::info
This post describes version 1.x. Version 2.0.0 is a full rewrite with built-in interpreters, email support, and an interactive CLI. See [What's New in v2.0.0](/blog/whats-new-in-v2/) for the current feature set.
:::
