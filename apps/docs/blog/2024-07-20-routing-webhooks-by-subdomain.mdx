...
:::info
This post describes version 1.x routing behavior. Version 2.0.0 uses context-based routing instead of subdomain-to-server mapping. See [What's New in v2.0.0](/blog/whats-new-in-v2/) for the current architecture.
:::
