/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../../wrangler.toml --strict-vars=false ./worker-configuration.d.ts` (hash: 61fe03370dde3da071e8e85bee42f26d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SETTINGS" | "SERVERS" | "CONTEXTS" | "NODE_ENV" | "LOG_LEVEL" | "LOG_TIME" | "CLOUDFLARE_API_TOKEN">> {}
}
