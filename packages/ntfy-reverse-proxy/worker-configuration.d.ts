/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config ../../wrangler.toml --strict-vars=false ./worker-configuration.d.ts` (hash: f277dfd022b319c2e89d4b216b9168ad)
// Runtime types generated with workerd@1.20260317.1 2026-04-07 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./build/src/worker/index");
	}
	interface Env {
		KV: KVNamespace;
		SETTINGS: string;
